...
public class SessionPusher {
    ...
    public void push(final DownStreamMsgContext downStreamMsgContext) {
        ...
        try {
            ...
            try{
                if(Command.REQUEST_TO_CLIENT.equals(cmd)) {
                    Properties extProperties = new Properties();
                    Trace.uploadTraceLog(LogPointType.LOG_EVENTMESH_REQ_RECEIVE, downStreamMsgContext.msgExt, retCode, retMsg,extProperties);
                }
            }catch (Exception e){
                logger.warn("uploadTraceLog failed in sessionPusher.push", e);
            }
        }
    }
