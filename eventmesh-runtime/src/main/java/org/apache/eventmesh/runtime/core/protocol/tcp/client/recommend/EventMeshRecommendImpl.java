...
public class EventMeshRecommendImpl implements EventMeshRecommendStrategy{
        ...
        for(EventMeshInfoData eventMeshInfoData : eventMeshInfoList.getEventMeshInfoDataList()){
            ...
            if(StringUtils.isNotBlank(idc)){
                if(StringUtils.equals(idc, localIdc)){
                    ...
                    remoteEventMeshMap.put(eventMeshInfoData.getEventMeshName(), eventMeshInfoData.getEndpoint());
                }
            }else{
                logger.error("EventMeshName may be illegal,idc is null,eventMeshName:{}",eventMeshInfoData.getEventMeshName());
            }
        }
    ...
    private String recommendProxyByDistributeData(String cluster, String group, String purpose, Map<String,String> eventMeshMap, boolean caculateLocal){
        ...
        if(eventMeshClientDistributionMapData == null || MapUtils.isEmpty(eventMeshClientDistributionMapData.getClientDistributionMap())) {
